...
export default function ArticleEndCTA({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-3 md:px-0 py-12 md:py-20 font-sans direction-rtl">
      {/* Main Card */}
        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch">
          ...
          <div className="relative z-10 w-full md:w-1/3 flex flex-col items-center md:items-start md:pr-10 mt-[-60px] md:mt-[-50px] mb-6 md:mb-0">
            ...
            <div className="relative group cursor-pointer mb-3">
              ...
              {/* Image Container (Resized desktop size to w-44 h-44) */}
            ...
            {/* Lawyer Name & Title (Fixed Visibility with !important) */}
