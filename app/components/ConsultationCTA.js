...
export default function ArticleEndCTA({
  ...
  return (
    ...
    <div className="absolute -top-32 -right-32 w-80 h-80 bg-[#E77D5D]/10 rounded-full blur-[100px]"></div>
    ...
    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#E77D5D]/40 to-[#D85C3D]/40 blur-2xl opacity-70 animate-pulse"></div>
    ...
    target="_blank"
    rel="noreferrer"
    className="group relative overflow-hidden flex-[1.6] bg-gradient-to-r from-[#E77D5D] to-[#D85C3D] hover:brightness-110 text-white font-black text-[15px] md:text-lg py-4 px-6 rounded-xl shadow-[0_6px_25px_-5px_rgba(231,125,93,0.4)] transition-all active:scale-98 hover:-translate-y-1 flex items-center justify-center gap-4 border border-white/10"
    >
